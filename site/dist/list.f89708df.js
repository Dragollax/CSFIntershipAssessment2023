...
function generateFavCards(data) {
    ...
    if (data.favourites.length !== 0) // for each list item, create a card
    ...
    else // if there are no list items then display this message
    favContainer.innerHTML = `
      <h3>Nothing Here...</h3>
    `;
}
...
//# sourceMappingURL=list.f89708df.js.map
